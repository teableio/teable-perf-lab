...
**Migrated: 13 / 35 runner kinds · 15 / 55 cases.**
...
| record-update           | `record-update-lifecycle.ts` (bulk update + restore-or-delete) | record-update/mixed-1k-20fields-bulk-update   | ✅ v1+v2 pass (local) |
