...
**Lifecycle: 37 / 40 runner kinds · 97 / 103 cases. Direct: 3 runner kinds · 6 cases.**

| Runner kind                 | Implementation                                      | Registered cases |
| --------------------------- | --------------------------------------------------- | ---------------: |
| `http-endpoint`             | direct                                              |                1 |
| `formula-table`             | `field-add-lifecycle`                               |                2 |
| `computed-outbox`           | `field-add-lifecycle` + `record-mutation-lifecycle` |                7 |
...
| `link-computed-propagation` | `record-mutation-lifecycle`                         |                2 |
...
| `table-delete-link`         | `table-link-lifecycle`                              |                1 |
...
| `record-delete-stream`      | `record-mutation-lifecycle`                         |                2 |
| `record-undo`               | `record-replay-lifecycle`                           |                1 |
| `record-redo`               | `record-replay-lifecycle`                           |                1 |
| `selection-clear`           | `record-mutation-lifecycle`                         |                1 |
