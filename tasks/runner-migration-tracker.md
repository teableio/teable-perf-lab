...
**Lifecycle: 38 / 41 runner kinds · 101 / 107 cases. Direct: 3 runner kinds · 6 cases.**
...
| `computed-chain-mutation`       | `record-mutation-lifecycle`                         |                6 |
| `customer-upsert-computed-flow` | `record-mutation-lifecycle`                         |                3 |
