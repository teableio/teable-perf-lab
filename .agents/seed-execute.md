...
conditional-lookup, conditional-rollup, lookup-search-index, field-create, field-delete,
...
| B     | only adds new objects next to it (fields) or reads it          | delete the execute-created objects, keep the seed table                       | formula-table, conditional-lookup, conditional-rollup, field-duplicate, field-create, lookup-search-index (read-only: nothing to clean)                                             |
