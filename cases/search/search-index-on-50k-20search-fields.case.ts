...
export default definePerfCase({
  id: "search/search-index-on-50k-20search-fields",
  title: "50k lookup global search with table search index",
  ...
  // with a diagnostic instead of waiting out the 1,200s case timeout.
  watchdogMs: 120_000,
  runtimeEnv: {
  ...
  config: {
    baseId: "seed-base",
    sourceTableNamePrefix: "perf-lookup-search-index-source-50k",
    hostTableNamePrefix: "perf-lookup-search-index-host-50k",
    tableIndexMode: "on",
    recordCount: 50_000,
    batchSize: 1_000,
    userCount: 10,
