...
export default definePerfCase({
  id: "lookup/conditional-group-text-update-1k-fanout100-limit50-10k",
  title: "10k conditional text lookup after 1k updates, limit 50 of 100",
  ...
  config: {
    ...
    field: {
      kind: "lookup",
      name: "Group Text Limit 50 after 1k Source Updates",
      valueField: "text",
      filter: "group",
