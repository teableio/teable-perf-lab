...
export default definePerfCase({
  id: "lookup/conditional-group-active-flip-1k-fanout100-30k",
  title: "30k conditional active lookup after 1k predicate flips",
  ...
  config: {
    ...
    field: {
      kind: "lookup",
      name: "30k Active Group Text after 1k Predicate Flips",
      valueField: "text",
