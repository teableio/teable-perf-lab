...
export default definePerfCase({
  id: "lookup/customer-update-user-update-order-4k-depth5",
  title:
    "Update one User and one linked Order, then await depth-5 computed flow",
  ...
  config: {
    baseId: "seed-base",
    tableNamePrefix: "perf-customer-update-user-update-order-4k-depth5",
