...
export default definePerfCase({
  id: "lookup/dual-link-computed-first-link-1of4k-get-record",
  title:
    "First-link one of 4k orders, await lookup readiness through getRecord",
  ...
  config: {
    baseId: "seed-base",
    mode: "first-link",
    ordersTableNamePrefix: "perf-lookup-dual-link-first-link-1of4k-record",
    rowCount: 4_000,
    batchSize: 1_000,
    writeBatchSize: 100,
    ...
    threshold: {
      ...
      // Local V1/V2 hybrid measured 36ms/189ms, leaving ~50x margin while
