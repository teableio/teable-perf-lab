...
Scale one foreign-text mutation from a 100-order to a 500-order depth-5 fanout.
...
Update one foreign text value through the baseline bulk-write path, assert routing, and verify first plus full 500-order readiness.
