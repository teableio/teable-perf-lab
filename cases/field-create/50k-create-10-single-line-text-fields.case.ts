...
export default definePerfCase({
  id: "field-create/50k-create-10-single-line-text-fields",
  title: "Create 10 single-line text fields on a 50k-record table",
  runner: "field-create",
  timeoutMs: 900_000,
  watchdogMs: 300_000,
  ...
  config: {
    ...scalarFieldCreate50kBase,
    tableNamePrefix: "perf-field-create-50k-10-single-line-text",
