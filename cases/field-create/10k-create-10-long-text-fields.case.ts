...
export default definePerfCase({
  id: "field-create/10k-create-10-long-text-fields",
  title: "Create 10 long-text fields on a 10k-record table",
  runner: "field-create",
  timeoutMs: 600_000,
  watchdogMs: 300_000,
  ...
  config: {
    ...scalarFieldCreateBase,
    tableNamePrefix: "perf-field-create-10k-10-long-text",
    fields: scalarFieldAddMatrix.longText10,
