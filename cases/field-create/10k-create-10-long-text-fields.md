---
owner: perf-lab
tags: [field-create, 10k, long-text, scalar-matrix]
enabled: true
---
...
Isolate long-text column creation from other scalar field types at a fixed ten
request count.
...
- Create ten long-text fields sequentially.
