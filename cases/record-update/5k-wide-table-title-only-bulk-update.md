...
Scale `record-update/1k-wide-table-title-only-bulk-update` from 1,000 to 5,000 records while preserving its field projection and one-request update behavior.
