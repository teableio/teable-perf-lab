...
Scale `record-update/1k-single-select-fields-bulk-update` from 1,000 to 5,000 records while preserving its three-field projection and one-request update behavior.
