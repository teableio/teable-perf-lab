...
export default definePerfCase({
  id: "record-update/5k-single-select-fields-bulk-update",
  title: "Bulk update 5k rows across three single-select fields",
  ...
  config: {
    ...
    tableNamePrefix: "perf-record-update-5k-single-select",
