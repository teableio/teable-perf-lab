...
export default definePerfCase({
  id: "record-update/5k-checkbox-fields-bulk-update",
  title: "Bulk update 5k rows across two checkbox fields",
  ...
  config: {
    ...
    tableNamePrefix: "perf-record-update-5k-checkbox",
    updateFieldNames: ["Active", "Approved"],
    verify: {
