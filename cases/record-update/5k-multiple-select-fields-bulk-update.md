...
Scale `record-update/1k-multiple-select-fields-bulk-update` from 1,000 to 5,000 records while preserving its two-field projection and one-request update behavior.
