...
Scale the single-record foreign-text update from a 100-order to a 500-order depth-5 fanout.
...
Update one text value through the single-record endpoint, assert routing, and verify first plus full 500-order readiness.
