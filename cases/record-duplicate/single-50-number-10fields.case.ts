...
export default definePerfCase({
  id: "record-duplicate/single-50-number-10fields",
  title: "Duplicate 50 records sequentially in a 10-field number table",
  runner: "record-duplicate-single",
  timeoutMs: 300_000,
  config: {
    ...recordDuplicateSingle50Base,
    tableNamePrefix: "perf-record-duplicate-single-50-number-10fields",
