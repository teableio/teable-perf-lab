...
Scale-up of `single-50-primary-only`: sequentially duplicates 500 source records
from a deterministic 1,000-row primary-only table. The primary metric remains
