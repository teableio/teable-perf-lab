...
export default definePerfCase({
  id: "record-duplicate/single-500-multiple-select-100fields",
  title:
    "Duplicate 500 records sequentially in a 100-field multiple-select table",
  runner: "record-duplicate-single",
  timeoutMs: 900_000,
  runtimeEnv: recordDuplicateSingle500TraceRuntimeEnv,
  config: {
    ...recordDuplicateSingle500Base,
    tableNamePrefix: "perf-record-duplicate-single-500-multi-select-100fields",
    fields: recordDuplicateSingle500WideFields.multipleSelect100,
