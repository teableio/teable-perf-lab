...
export default definePerfCase({
  id: "record-duplicate/single-500-long-text-100fields",
  title: "Duplicate 500 records sequentially in a 100-field long-text table",
  runner: "record-duplicate-single",
  timeoutMs: 900_000,
  runtimeEnv: recordDuplicateSingle500TraceRuntimeEnv,
  config: {
    ...recordDuplicateSingle500Base,
    tableNamePrefix: "perf-record-duplicate-single-500-long-text-100fields",
    fields: recordDuplicateSingle500WideFields.longText100,
