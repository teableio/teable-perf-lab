...
Scale-up of `single-500-single-select-10fields`: duplicate 500 source records
sequentially while increasing each record from 10 to 100 single-select fields.

## Seed Phase

Create and validate 1,000 deterministic rows in a 100-field single-select table before timing.
