...
Scale-up of `single-500-checkbox-10fields`: duplicate 500 source records sequentially
while increasing each record from 10 to 100 checkbox fields.

## Seed Phase

Create and validate 1,000 deterministic rows in a 100-field checkbox table before timing.
