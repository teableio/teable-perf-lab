...
Scale-up of `single-500-rating-10fields`: duplicate 500 source records sequentially
while increasing each record from 10 to 100 rating fields.

## Seed Phase

Create and validate 1,000 deterministic rows in a 100-field rating table before timing.
