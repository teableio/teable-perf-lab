...
export default definePerfCase({
  id: "record-duplicate/grid-block-duplicate-1k",
  title: "Duplicate a 1k row block through the grid selection stream",
  runner: "selection-duplicate",
  timeoutMs: 900_000,
  config: {
    baseId: "seed-base",
    tableNamePrefix: "perf-record-duplicate-grid-block-duplicate-1k",
    rowCount: 10_000,
    batchSize: 1_000,
    fields: [
