...
export default definePerfCase({
  id: "record-duplicate/single-500-single-line-text-10fields",
  title: "Duplicate 500 records sequentially in a 10-field text table",
  runner: "record-duplicate-single",
  timeoutMs: 900_000,
  config: {
    ...recordDuplicateSingle500Base,
    tableNamePrefix:
      "perf-record-duplicate-single-500-single-line-text-10fields",
