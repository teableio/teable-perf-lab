...
Scale `record-create/1k-single-line-text-fields-bulk-create` from 1,000 to 5,000 records while preserving its four-field projection and one-request create behavior.
