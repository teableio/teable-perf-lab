...
Scale `record-create/1k-rating-field-bulk-create` from 1,000 to 5,000 records while preserving the same field projection and one-request create behavior.
