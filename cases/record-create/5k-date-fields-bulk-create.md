...
Scale `record-create/1k-date-fields-bulk-create` from 1,000 to 5,000 records while preserving its two-date-field projection and one-request create behavior.
