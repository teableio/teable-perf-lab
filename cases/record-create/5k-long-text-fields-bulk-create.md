...
Scale `record-create/1k-long-text-fields-bulk-create` from 1,000 to 5,000 records while preserving its three-field projection and one-request create behavior.
