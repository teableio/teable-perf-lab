...
export default definePerfCase({
  id: "record-create/5k-single-select-fields-bulk-create",
  title: "Bulk create 5k rows across three single-select fields",
  ...
  config: {
    ...
    tableNamePrefix: "perf-record-create-5k-single-select",
