...
Scale `record-create/1k-multiple-select-fields-bulk-create` from 1,000 to 5,000 records while preserving the same field projection and one-request create behavior.
