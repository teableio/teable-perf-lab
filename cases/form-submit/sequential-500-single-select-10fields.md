...
Scale-up of `sequential-50-single-select-10fields`: submits 500 deterministic
10-field single-select records through a Form view. `formSubmitP95Ms` keeps the
