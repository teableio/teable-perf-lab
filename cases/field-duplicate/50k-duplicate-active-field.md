---
owner: backend-v2
tags: [field, duplicate, 50k, checkbox, scale-up, v1-v2]
enabled: true
---
...
Scale populated checkbox-field duplication from 10k to 50k rows.
...
Duplicate `Active` to `Active Copy` through the public endpoint. Time only the
