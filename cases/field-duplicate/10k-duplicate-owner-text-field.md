...
Measure duplicating one populated single-line text field and its 10,000 values.

## Seed Phase

- Create a table with primary `Title` and single-line text `Owner Text`.
...
2. Duplicate it to `Owner Text Copy` through the public field endpoint.
