...
Measure duplicating one populated long-text field and its 10,000 values.

## Seed Phase

- Create a table with primary `Title` and long-text `Description`.
...
2. Duplicate it to `Description Copy` through the public field endpoint.
