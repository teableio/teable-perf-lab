---
owner: backend-v2
tags: [field, duplicate, 50k, rating, scale-up, v1-v2]
enabled: true
---
...
Scale populated rating-field duplication from 10k to 50k rows.
...
Duplicate `Score` to `Score Copy` through the public endpoint. Time only the
