---
owner: backend-v2
tags: [field, duplicate, 50k, number, scale-up, v1-v2]
enabled: true
---
...
Scale populated number-field duplication from 10k to 50k rows.
...
Duplicate `Amount` to `Amount Copy` through the public endpoint. Time only the
