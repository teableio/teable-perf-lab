...
export default definePerfCase({
  id: "record-paste/mixed-10k-20fields-complex-copy-paste",
  title: "Paste 10k mixed records into an empty 20-field table",
  runner: "record-paste",
  timeoutMs: 900_000,
  config: {
    baseId: "seed-base",
    tableNamePrefix: "perf-record-paste-mixed-10k-20fields-complex-copy-paste",
    rowCount: 10_000,
    ...
    threshold: {
      metric: "paste10kMs",
      // Calibrated 2026-06-22 from 289 CI runs (v1+v2, Apr-Jun 2026): p95 ~22080ms,
      // worst ~29432ms. Guardrail ~2x worst - catches a real ~2x regression without
      // flaking on CI variance (was 480_000).
      maxMs: 60_000,
    },
  },
});
