...
Add a record when an investigation concludes "leave this as it is" for a reason
that is not obvious from the code — especially when the surface looks like a
defect and is not.
