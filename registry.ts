...
import computeActivityPollStormUnderWriteLoad10kCase from "./cases/compute-activity/poll-storm-under-write-load-10k.case";
...
const cases = [
  ...
  computeActivityPollStormUnderWriteLoad10kCase,
