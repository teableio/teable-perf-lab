...
import dualLinkComputedFirstLink10kCase from "./cases/lookup/dual-link-computed-first-link-10k.case";
import dualLinkComputedRepoint10kCase from "./cases/lookup/dual-link-computed-repoint-10k.case";
...
const cases = [
  ...
  dualLinkComputedFirstLink10kCase,
  dualLinkComputedRepoint10kCase,
...
const caseAliases = new Map([
  ...
  ["lookup/dual-link-first-link", "lookup/dual-link-computed-first-link-10k"],
  ["lookup/dual-link-repoint", "lookup/dual-link-computed-repoint-10k"],
